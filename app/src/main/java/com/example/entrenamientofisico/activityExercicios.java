...
public class activityExercicios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String abdominales[][] = {
                {"Russian twists","Para este ejercicio, siéntate en el suelo y agarra con ambas manos la mancuerna y vas a moverla un lado, como si la fueras a llevar hacia atrás de tu espalda, de esta manera tu abdomen y oblicuos trabajan. Repite en cada lado.", "https://media.giphy.com/media/RgRIG7FMlrDvatdy87/giphy.gif", "x8"},
                ...
                {"Vuelta del mundo","Para este siguiente ejercicio, ponte de pie y con ambas manos agarra tu pesa o mancuerna. Haciendo movimientos circulares lleva la mancuerna desde abajo hacia arriba.", "https://media.giphy.com/media/P1dzjL7SILpQNecijc/giphy.gif", "x8"},
                ...
                {"Abs curls con mancuerna","Con ambas manos la vamos a poner detrás de nuestra cabeza. En el momento que te levantas, en un movimiento circular tenemos que llevar la pesa a nuestro abdomen.", "https://media.giphy.com/media/MFUeCr0EajTb2qwRlx/giphy.gif", "x8"},
