...
public class activityExercicios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pierna[][] = {
                {"Salto lateral","De pie, coloca las manos frenrte a ti y salta de un lado a otro.", "https://fernando-leon.github.io/urlsAnimation/gif1.gif", "30s"},
                ...
                {"Donkey kicks lzquierdo","Comienza a cuatro patas con las rodilas bajo el trasero y las manos directamente bajo los hombros. Después levanta la pierna izquierda todo lo que puedas apretando el trasero.", "https://fernando-leon.github.io/urlsAnimation/gif1.gif", "x16"},
                {"Donkey Kick Derecha","Comienza a cuatro patas con las rodillas bajo el trasero y las manos directamente bajo los hombros. Después levanta la pierma derecha todo lo que puedas apretando el trasero.", "https://fernando-leon.github.io/urlsAnimation/gif1.gif", "x16"},
                {"Levantamientos de pantorilla con pared","De pie, con las manos en la pared y los pies alineados con los hombros. Levanta los talones y apóyate sobre los dedos de los pies. A continuación, baja los talones. Repite el ejercicio.", "https://fernando-leon.github.io/urlsAnimation/gif1.gif", "x12"},
                {"Levantamientos de pantorilla con sentadilla de sumo y pared","De pie, con las manos en la pared y los pies un poco separados de los hombros. Baja el cuerpo hasta que los muslos estén paralelos al suelo. Levanta los talones y bájalos.", "https://fernando-leon.github.io/urlsAnimation/gif1.gif", "x12"},
                {"Zancada Cruzada","Póngase de pie y de un paso hacia atrás con la pierna izquierda hacia la derecha y agáchese al mismo tiemp0. Vuelve a la posición de antes y cambie de piernas.", "https://fernando-leon.github.io/urlsAnimation/gif1.gif", "x14"},
